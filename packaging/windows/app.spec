...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "lgtv_easy.netdiag", "lgtv_easy.recovery", "lgtv_easy.selfheal",
        "lgtv_easy.singleton", "lgtv_easy.system_sleep", "lgtv_easy.webos",
        "lgtv_easy.wizard_text", "lgtv_easy.wol", "lgtv_easy._dbus",
        "lgtv_easy._ws",
    ],
    hookspath=[],
    runtime_hooks=[],
